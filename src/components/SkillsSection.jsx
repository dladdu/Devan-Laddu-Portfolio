...
const skills = [
    ...
    //Tools
    { name: "Amazon Web Services", level: 75, category: "tools" },
    { name: "Amazon Q", level: 95, category: "tools" },
    { name: "S3", level: 75, category: "tools" },
    { name: "Microsoft Office", level: 95, category: "tools" },
